...
def general_qna_interface():
    ...
    # ---------------------------------------------------------------------------
    # 🚀 UPDATE: ปรับ System Instruction ให้ฉลาดขึ้น + ต้องถามหาพื้นที่
    # ---------------------------------------------------------------------------
    system_instruction = (
        ...
        "ให้คุณถามกลับไปทันทีว่า 'ต้องการทราบข้อมูลสภาพอากาศของพื้นที่ใดครับ?' เพื่อให้ได้ข้อมูลที่ถูกต้อง ห้ามเดาสถานที่เอง"
    )
